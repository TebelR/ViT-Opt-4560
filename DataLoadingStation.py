...
class DataLoadingStation:
    ...
    def load_data_classification(self, training_split, validation_split):
        ...
        self.dataset_train_classification, self.dataset_validate_classification = random_split(self.dataset_classification, [train_size, validate_size])
